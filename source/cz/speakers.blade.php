...
@section('title')
<title>Speakers - Red Hat Czech Open House</title>
@endsection
	...
	<nav class="mb-1 navbar navbar-expand-lg navbar-dark fixed-top masthead">
		...
		<div class="collapse navbar-collapse" id="navbarMobile">
			<ul class="navbar-nav ml-auto pr-5">
				...
				<li class="nav-item active px-3">
					<a href="#" class="nav-link local">Speakers</a>
				</li>
<!--				<li class="nav-item active px-3">
...
<iframe src="/cz/speakers-load/index.html" width="100%" style="border: 0px; min-height: 100vh"></iframe>
</section>
