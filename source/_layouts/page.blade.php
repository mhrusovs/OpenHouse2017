...
<html lang="en">
	...
	<meta name="description" content="Red Hat Czech Open House is the annual, free, virtual event organized by Red Hat Czech associates who are keen to present their work and experience and share Red Hat culture and values.">
...
<!--						<a class="col-md-6 col-12" target="_blank" href="/coc">Code of Conduct</a>
						...
						<a class="col-md-6 col-12" target="_blank" href="/cz/cob">Code of behavior</a>
						<a class="col-md-6 col-12" target="_blank" href="https://www.redhat.com/en/about/privacy-policy">Privacy Statement</a>
						</div>
					</div>
				</div>
			</div>
		</div>
		<div class="row px-5 py-3 w-100 mx-auto copyright-wrapper">
			<div class="col-lg-11 mx-auto copyright">
				Copyright &copy;<?php echo date("Y", time()); ?> Red Hat, Inc.
			</div>
		</div>
	</footer>
	<div id="cookie">
		<div id="cookie-wrapper">
			<div id="cookie-text">
			 ...
			 set in our <a href="https://www.redhat.com/en/about/privacy-policy" target="_blank">Privacy Statement</a>. By using this website you agree to our use of cookies.
			</div>
